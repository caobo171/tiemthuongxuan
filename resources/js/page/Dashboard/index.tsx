...
const Dashboard = React.memo(() => {
	...
	useEffect(() => {
		...
		function number_format(number, decimals = 0, dec_point = undefined, thousands_sep = undefined) {
		...
		var myPieChart = new Chart(pieRef.current, {
			type: 'doughnut',
			data: {
						...
						<div className="card-body">
							<div className="chart-area"><div className="chartjs-size-monitor">
								<div className="chartjs-size-monitor-expand">
									<div className=""></div></div><div className="chartjs-size-monitor-shrink">
									<div className=""></div>
								</div></div>
								<canvas
									ref={chartRef}
									style={{ display: 'block', width: 1039, height: 320 }} width={1039} height={320}
